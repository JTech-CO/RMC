...
> 이 ZIP은 기존 2.0.0 인계본에 UI 가독성 변경을 적용한 **2.0.1 수정본**입니다. 원격 저장소에 발행된 릴리스는 아닙니다. 화면은 실제 앱 HTML/CSS와 고정 샘플 문서를 격리된 레이아웃 테스트에서 렌더한 것이며, 실호스팅 변환기의 실행을 증명하지 않습니다. 검증 범위는 QA 보고서에 구분했습니다.
